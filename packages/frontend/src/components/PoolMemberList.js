...
import { GET_POOL_MEMBER_DETAIL, GET_POOL_MEMBERS } from "../helpers/graphQlQueries";
...
const PoolMemberListView = higherProps => (
  <Switch>
    <Route exact path="/pool-members" render={props => <PoolMemberList {...props} loggedInUser={higherProps.loggedInUser} />} />
    <Route path="/pool-members/:name" render={props => <MemberDetail {...props} loggedInUser={higherProps.loggedInUser} />} />
  </Switch>
);
